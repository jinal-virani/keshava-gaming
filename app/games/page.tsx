...
export default function GamesPage() {
  console
  return (
    <motion.section variants={pageTransition} animate="animate" exit="exit" className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8 pb-28 md:pb-12">
      ...
      {/* <motion.div variants={staggerParent} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
       ...
       <motion.div variants={staggerParent} whileInView="show" viewport={{ once: true, amount: 0.2 }} className="grid grid-cols-1 gap-6 lg:grid-cols-1">
